{
	...
	addImage:[
		...
		["wp","resources/wallpaper.png"],
		["warn","resources/warn.png"],
	...
	addAudio:[
		...
		["error0",[audioserver+"error0.mp3",audioserver+"error0.ogg"],{channel:"sfx",volume:0.5}],
		["error1",[audioserver+"error1.mp3",audioserver+"error1.ogg"],{channel:"sfx",volume:0.5}],
		["coin",[audioserver+"coin.mp3",audioserver+"coin.ogg"],{channel:"sfx"}],
		["intro",[audioserver+"intro.mp3",audioserver+"intro.ogg"],{channel:"bgmusic"}],
	...
	addBundle:[
		...
		{file:"resources/bundle-song-fifth.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
		{file:"resources/bundle-song-skee.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
		{file:"resources/bundle-song-demo.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
